---
layout: page
title: 李飞飞:空间智能是AI的下一个前沿
description: 从文字到世界,World Labs开启空间智能新时代
img: assets/img/spatial-intelligence-cover.jpg
importance: 2
category: work
date: 2025-11-10
tags: [AI, 空间智能, 李飞飞, World Labs, 机器人]
---

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/feifei-li-stanford.jpg" title="李飞飞教授" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/spatial-ai-concept.jpg" title="空间智能概念图" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/world-labs-logo.jpg" title="World Labs" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/imagenet.jpg" title="ImageNet数据集" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/ai-evolution.jpg" title="AI发展历程" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/world-model.jpg" title="世界模型" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/spatial-perception.jpg" title="人类空间感知" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    人类依赖空间智能完成日常任务
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/earth-measurement.jpg" title="埃拉托色尼测量地球" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/dna-structure.jpg" title="DNA双螺旋结构" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/llm-vs-world-model.jpg" title="LLM vs 世界模型" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/generative-capability.jpg" title="生成性" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/multimodal-capability.jpg" title="多模态" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/interactive-capability.jpg" title="交互性" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/marble-demo.jpg" title="Marble演示" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/filmmaking-ai.jpg" title="AI辅助电影制作" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/game-design-ai.jpg" title="AI辅助游戏设计" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/robotics-spatial-ai.jpg" title="机器人与空间智能" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    空间智能是实现通用机器人的关键
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/scientific-research-ai.jpg" title="科学研究" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/healthcare-ai.jpg" title="医疗应用" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/education-ai.jpg" title="教育创新" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-10 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/future-spatial-ai.jpg" title="空间智能的未来" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    空间智能:AI的下一个伟大前沿
...
- [李飞飞斯坦福主页](https://profiles.stanford.edu/fei-fei-li)
